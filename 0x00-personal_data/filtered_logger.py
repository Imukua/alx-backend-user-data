#!/usr/bin/env python3
"""
Script for Personal Data handlingg
"""
...
def filter_datum(fields: List[str], redaction: str,
    ...
    """
    Replace sensitive info in  message with  redacted value
...
def get_db() -> mysql.connector.connection.MySQLConnection:
    """
    MySQL Connection object for accessing Personal Data 
    """
...
def main():
    """
    Main function: retrieves user data from database and logs to console
    """
    db = get_db()
    cursor = db.cursor()
